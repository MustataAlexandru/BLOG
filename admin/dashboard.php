...
<div id="wrapper">
   ...
   $user_image = $_SESSION['user_image'] ;
    ...
    <img class="boxShadow" href ="sub_profile.php" style="border: 1px solid #e3e3e3; height: 70px;  width: 48px;position: absolute; right: 2%; top:7%; border-radius: 15%; " src="../images/<?php echo $user_image; ?>" />
    </a>
    <div id="page-wrapper">
                ...
                <script type="text/javascript">
                    ...
                    function drawChart() {
                        var data = google.visualization.arrayToDataTable([
                            ...
                            $element_text = ['Toate Postarile','Postari Active','Postari in lucru' ,'Comentarii','Comentarii neaprobate','Categorii'];
                            $element_count = [$post_counts,$published_posts_count ,$draft_posts_count ,$comment_counts,$unapproved_comments_count ,   $categories_count];
                            for($i = 0; $i < 6; $i++) {
...
//                                ['Posts', 1000],
            ...
            <div id="columnchart_material" style="width: 'auto'; height: 50rem;"></div>
        </div>
    </div>
