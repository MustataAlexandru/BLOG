                    ...
                    <script type="text/javascript">
                        ...
                        function drawChart() {
                            var data = google.visualization.arrayToDataTable([
                               ...
                               $element_text = ['Toate Postarile','Postari Active','Postari in lucru' ,'Comentarii','Comentarii neaprobate', 'Utilizatori','Subscriberi',  'Categorii'];
                               $element_count = [$post_counts,$published_posts_count ,$draft_posts_count ,$comment_counts,$unapproved_comments_count , $user_counts,$subscriber_count , $categories_count];
                               for($i = 0; $i < 8; $i++) {
