...
function insert_categories(){
    ...
    $stmt = mysqli_prepare($connection, "INSERT INTO categories(cat_title, cat_user_id) VALUES(?,?) ");
...
global $connection;
    ...
    while($row = mysqli_fetch_assoc($select_categories)) {
        ...
        echo "<td>{$cat_id}</td>";
        echo "<td>{$cat_title}</td>";
        echo "<td><a href='sub_categories.php?delete={$cat_id}'>Delete</a></td>";
        echo "<td><a href='sub_categories.php?edit={$cat_id}'>Edit</a></td>";
        echo "</tr>";
...
global $connection;
    ...
    if($_SESSION['user_role'] =='admin')header("Location: categories.php");
    else header('Location: sub_categories.php');
